      ...
      <id="H2"><b>Delivery Tracking Platform Parcel In UMP</b> </p>
        <h6 class="text-center" style="font-family:courier;" style="font-size:15px;">
          <id="h6">"Make Ease Life University Student"</p>
            <img src="https://www.jtexpress.sg/hs-fs/hubfs/JT%20Express%20Logos/Logo%20J%26T%20Express-02.png?width=2089&height=784&name=Logo%20J%26T%20Express-02.png" width="350" height="150">
            <!--input for Number Tracking-->
            <form method="post" class="example" id="myForm" action="" onsubmit="alertFunction()">
